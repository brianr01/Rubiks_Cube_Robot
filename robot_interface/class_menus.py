...
class menus:
    def __init__(self, menus, starting_menu):
        ...
        for menu_name in menus:
            self.menus[menu_name] = class_menu.menu(menus[menu_name]['frames'], menus[menu_name]['buttons'])
    ...
    def update(self, cursor_x, cursor_y, mouse_code):
        self.menus[self.current_menu_name].update(cursor_x, cursor_y, mouse_code)
