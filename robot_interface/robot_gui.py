...
polygons_button = {'size':[150, 50], 'location':[0, 400],'color':'red', 'text_color':'white', 'text':'polygons', 'action':change_menu, 'parameters':'main'}

colors_button = {'size':[120, 50], 'location':[150, 400],'color':'green', 'text_color':'blue', 'text':'colors', 'action':change_menu, 'parameters':'main'}
...
profiles_menu = {'buttons':[back_to_calibrate_button, quit_button], 'frames':[profile_1_segment]}
menus_data = {'main':main_menu, 'calibrate':calibrate_menu, 'profiles':profiles_menu}
